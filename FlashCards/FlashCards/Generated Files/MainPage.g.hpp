...
void ::FlashCards::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::FlashCards::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::FlashCards::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
